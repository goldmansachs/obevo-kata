...
alter table Account drop column rollbackImmediate
GO

//// CHANGE name="rollbackScripted"
alter table Account add column rollbackScripted integer
GO

// ROLLBACK
alter table Account drop column rollbackScripted
GO
